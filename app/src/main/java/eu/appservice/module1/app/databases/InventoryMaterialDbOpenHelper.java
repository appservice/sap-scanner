package eu.appservice.module1.app.databases;
...
public class InventoryMaterialDbOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_PICKED_QUANTITY = "pickedQuantity";
    ...
    private static final String[] ALL_COLUMNS_TABLE = new String[]{COLUMN_ID, COLUMN_INDEX, COLUMN_NAME, COLUMN_UNIT, COLUMN_AMOUNT, COLUMN_STORE, COLUMN_DESCRIPTION, COLUMN_PICKED_QUANTITY, COLUMN_BUDGET, COLUMN_MPK, COLUMN_IS_ZERO, COLUMN_DATE, COLUMN_SIGN_ADDRESS};
    ...
    public boolean addPickedMaterial(CollectedMaterial material) {
        ...
        cv.put(COLUMN_PICKED_QUANTITY, material.getCollectedQuantity());
    ...
    public CollectedMaterial getPickedMaterial(int id) {
        ...
        String columns[] = new String[]{COLUMN_ID, COLUMN_INDEX, COLUMN_NAME, COLUMN_UNIT, COLUMN_AMOUNT, COLUMN_STORE, COLUMN_DESCRIPTION, COLUMN_PICKED_QUANTITY, COLUMN_BUDGET, COLUMN_MPK, COLUMN_IS_ZERO, COLUMN_DATE, COLUMN_SIGN_ADDRESS};//
    ...
    public int updatePickedMaterial(CollectedMaterial collectedMaterial){
        ...
        cv.put(COLUMN_PICKED_QUANTITY, collectedMaterial.getCollectedQuantity());
    ...
    public List<CollectedMaterial> getAllCollectedMaterials() {
        List<CollectedMaterial> allCollectedMaterials = new ArrayList<CollectedMaterial>();
        SQLiteDatabase db = this.getReadableDatabase();
     ...
     */
    public List<CollectedMaterial> getPickedMaterialsByIndexAndName(String index, String name, String mpk, String budget) {
