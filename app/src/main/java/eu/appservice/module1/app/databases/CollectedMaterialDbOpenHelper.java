...
public class CollectedMaterialDbOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String[] ALL_COLUMNS_TABLE = new String[]{COLUMN_ID, COLUMN_INDEX, COLUMN_NAME, COLUMN_UNIT, COLUMN_AMOUNT, COLUMN_STORE, COLUMN_DESCRIPTION, COLUMN_COLLECTED_QUANTITY, COLUMN_BUDGET, COLUMN_MPK, COLUMN_IS_ZERO, COLUMN_DATE, COLUMN_SIGN_ADDRESS};
    ...
    public CollectedMaterial getPickedMaterial(int id) {
        ...
        String columns[] = new String[]{COLUMN_ID, COLUMN_INDEX, COLUMN_NAME, COLUMN_UNIT,
                COLUMN_AMOUNT, COLUMN_STORE, COLUMN_DESCRIPTION, COLUMN_COLLECTED_QUANTITY, COLUMN_BUDGET,
     ...
     */
    public List<CollectedMaterial> getAllPickedMaterials() {
     ...
     */
    public List<CollectedMaterial> getPickedMaterialsByIndexAndName(String index, String name, String mpk, String budget,boolean isRunning) {
...
// wyszukiwanie przez poszczeg�lne por�wniania w kolumnach
    ...
    public List<CollectedMaterial> getPickedMaterialsByIndexAndName(String index, String name, String mpk, String budget){
        return getPickedMaterialsByIndexAndName(index,name,mpk,budget,true);
    }
}
