...
import eu.appservice.databases.InventoryMaterialDbOpenHelper;
...
public class InventoryActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSaveInvActiv = (Button) findViewById(R.id.btnSaveInvActiv);
        btnPlaceInvActiv = (Button) findViewById(R.id.btnPlaceInvActiv);
        imgBtnSearchInvActiv = (ImageButton) findViewById(R.id.imgBtnSearchInvActiv);
        imgBtnScanInvActiv = (ImageButton) findViewById(R.id.imgBtnScanInvActiv);

        tvInventoryPlace = (TextView) findViewById(R.id.tvPlaceInvActiv);
        textViewNameInvActiv = (TextView) findViewById(R.id.textViewNameInvActiv);
        textViewAmountInvActiv = (TextView) findViewById(R.id.textViewAmountInvActiv);
        textViewUnitInvActiv = (TextView) findViewById(R.id.textViewUnitInvActiv);
        textViewStockInvActiv = (TextView) findViewById(R.id.textViewStockInvActiv);


        textViewIndexInvActiv = (EditText) findViewById(R.id.textViewIndexInvActiv);
        editTextAddValueInvActiv = (EditText) findViewById(R.id.editTextAddValueInvActiv);
    ...
    private void initButtonsClick() {
        View.OnClickListener btnListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.btnSaveInvActiv:
                        addMaterialToInventory();
                        // new ImportMaterialsPoiEventAsyncTask(InventoryActivity.this).execute();
                        break;
                    case R.id.imgBtnSearchInvActiv:
                        showSearchActivity();
                        break;
                    case R.id.imgBtnScanInvActiv:
                        showScanner();
                        break;
                    case R.id.btnPlaceInvActiv:
                        showPlaceDialog();
                        break;
