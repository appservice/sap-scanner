...
public class NewMaterialActivity extends ActionBarActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            editTextIndexAddActiv = (EditText) findViewById(R.id.editTextIndexAddActiv);
            editTextNameAddActiv = (EditText) findViewById(R.id.editTextNameAddActiv);
            editTextStoreAddActiv = (EditText) findViewById(R.id.editTextStoreAddActiv);
            spinnerUnitAddStore = (Spinner) findViewById(R.id.spinnerAddActiv);
            btnAddNewMaterialActiv = (Button) findViewById(R.id.btnAddNewMaterialActiv);
            initButtonsClick();
        }
        ...
        private void initButtonsClick() {
            View.OnClickListener buttonListener = new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    switch (v.getId()) {
                        case R.id.btnAddNewMaterialActiv:
                            addMaterial();
                            break;
                        default:
                            break;
