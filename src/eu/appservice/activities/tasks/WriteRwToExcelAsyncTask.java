...
public class WriteRwToExcelAsyncTask extends AsyncTask<Void, Integer, Void> implements  InterfaceObservable {
    ...
    public WriteRwToExcelAsyncTask(Activity context) {
        ...
        this.observersList = new ArrayList<InterfaceObserver>();
    ...
    protected Void doInBackground(Void... params) {
        if (isExternalStorageWritable()) {
            ...
            try {
                ...
                collectedMaterialList = (ArrayList<CollectedMaterial>) materialsDb.getAllPickedMaterials();
                ...
                for (CollectedMaterial cm : collectedMaterialList) {
                    ...
                    if (cm.getSignAddress().length() > 0) {
                        ...
                        java.io.File imageFile = readImageFile(cm.getSignAddress());
    ...
    private java.io.File readImageFile(String fileName) {
